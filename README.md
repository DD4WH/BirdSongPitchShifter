...
It implements **pitch shifting in the time domain** and is based on an idea by Harold Mills and Lang Elliott for the "Hear birds again"-project. It can shift the audio down by a factor of two (one octave), three (1.5 octaves) or four (two octaves). Here is a graph showing the implementation for the case of downshifting by 4.
